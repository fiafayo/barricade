...
<head>
	...
	<title>Academic Advisor | Kajur :: Home Kajur </title>
		...
		<div id="content">
            <table border="0" width="100%" height="350px">
			  <tr>
				...
				<p>
				 <p>Selamat datang Kajur, di website Academic Advisor Universitas Surabaya. </p>
			<p>Fasilitas yang dimiliki oleh Kajur pada website ini antara lain:<br/>
