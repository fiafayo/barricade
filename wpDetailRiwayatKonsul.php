...
<head>
	...
	?>
	<title>Academic Advisor | <? if($brsjbtn['KodeJabatan']==1) echo"Wakil Rektor"; else echo"PLKPAM"; ?> :: Detail Riwayat Konsultasi <? if($brsjbtn['KodeJabatan']==1) echo"Wakil Rektor"; else echo"PLKPAM"; ?> </title>
				...
				<? $baris=mysql_fetch_assoc($hasil);
					...
					if($baris)
					{
					   ...
					   while($baris)
					   {
							...
							{
									echo "
							<tr bgcolor='#E2E2E2'><td>".$warna."</td><td>".$baris['Tanggal']."</td><td>".$baris['JamDatang']."</td><td>".$baris['NamaDsn']."</td><td>$potonganmslh</td><td>$potongansrn</td><td>$potonganhsl</td><td><a href='wpBacaSelengkapnya.php?kode=".$baris['Kode']."&kategori=".$kategori."'><input type='button' value='Detail' border='0'></a></td></tr>";
							}
							else
							{
								echo "
							<tr bgcolor='#F0F0F0'><td>".$warna."</td><td>".$baris['Tanggal']."</td><td>".$baris['JamDatang']."</td><td>".$baris['NamaDsn']."</td><td>$potonganmslh</td><td>$potongansrn</td><td>$potonganhsl</td><td><a href='wpBacaSelengkapnya.php?kode=".$baris['Kode']."&kategori=".$kategori."'><input type='button' value='Detail' border='0'></a></td></tr>";
							}
							$warna=$warna+1;
							$baris=mysql_fetch_assoc($hasil); }
						echo"</table>";
			  		...
			  		<?php //PAGING
						if($isi==true)
						{
							if ($page != 1)
							{
								...
								print "<a href='wpDetailRiwayatKonsul.php?nrp=$nrp&kategori=$kategori'>&lt;&lt;First</a>";
								print "&nbsp;&nbsp;<a href='wpDetailRiwayatKonsul.php?page=$prev&nrp=$nrp&warna=$warna&kategori=$kategori'>&lt;Prev<a>&nbsp;&nbsp;";
							}
							...
							for ($i = $batasBawah; $i <= $batasAtas; $i++)
							{
								...
								else
								{
									...
									print "<a href='wpDetailRiwayatKonsul.php?page=$i&nrp=$nrp&warna=$warna&kategori=$kategori'>$i</a> ";
								}
							}
							...
							if ($page != $totalPage)
							{
								...
								print "&nbsp;&nbsp;<a href='wpDetailRiwayatKonsul.php?page=$next&nrp=$nrp&warna=$warna&kategori=$kategori'>Next&gt;</a>&nbsp;&nbsp;";
								$warna=($totalPage-1)*($itemPerPage)+1;
								print "<a href='wpDetailRiwayatKonsul.php?page=$totalPage&nrp=$nrp&warna=$warna&kategori=$kategori'>Last&gt;&gt;</a>";
							}
						}
							//END OF PAGING ?>
