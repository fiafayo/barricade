<?php
	...
	$query="SELECT h.*, d.JamDatang, d.NRP, p.Tanggal, m.Nama as NamaMhs, f.Nama as NamaFakultas, j.Nama as NamaJurusan, o.Nama as NamaDsn , o.Kode as KodeDsn
					...
					if($baris)
					{
					   ...
					   while($baris)
					   {
							...
							$hslkon=strip_tags($baris['HasilKonsultasi']);
                                                        if ( !$baris['confidential'] || ($baris['KodeDsn']==$username) ) {
                                                            ...
                                                            $potonganmslh="confidential";
                                                            $potongansrn="confidential";
                                                            $potonganhsl="confidential";
                                                        }
							
							if($warna%2==0)
							{
									echo "
							<tr bgcolor='#E2E2E2'><td>".$warna."</td><td>".$baris['Tanggal']."</td><td>".$baris['JamDatang']."</td><td>".$baris['NamaDsn']."</td><td>$potonganmslh</td><td>$potongansrn</td><td>$potonganhsl</td><td><a href='bacaSelengkapnya.php?kode=".$baris['Kode']."'><input type='button' value='Detail' border='0'></a></td></tr>";
							}
							else
							{
								echo "
							<tr bgcolor='#F0F0F0'><td>".$warna."</td><td>".$baris['Tanggal']."</td><td>".$baris['JamDatang']."</td><td>".$baris['NamaDsn']."</td><td>$potonganmslh</td><td>$potongansrn</td><td>$potonganhsl</td><td><a href='bacaSelengkapnya.php?kode=".$baris['Kode']."'><input type='button' value='Detail' border='0'></a></td></tr>";
							}
							$warna=$warna+1;
							$baris=mysql_fetch_assoc($hasil); }
						echo"</table>";
			  		...
			  		<?php //PAGING
						if($isi==true)
						{
							if ($page != 1)
							{
								...
								print "<a href='detailRiwayatKonsul.php?nrp=$nrp'>&lt;&lt;First</a>";
								print "&nbsp;&nbsp;<a href='detailRiwayatKonsul.php?page=$prev&nrp=$nrp&warna=$warna'>&lt;Prev<a>&nbsp;&nbsp;";
							}
							...
							for ($i = $batasBawah; $i <= $batasAtas; $i++)
							{
								...
								else
								{
									...
									print "<a href='detailRiwayatKonsul.php?page=$i&nrp=$nrp&warna=$warna'>$i</a> ";
								}
							}
							...
							if ($page != $totalPage)
							{
								...
								print "&nbsp;&nbsp;<a href='detailRiwayatKonsul.php?page=$next&nrp=$nrp&warna=$warna'>Next&gt;</a>&nbsp;&nbsp;";
								$warna=($totalPage-1)*($itemPerPage)+1;
								print "<a href='detailRiwayatKonsul.php?page=$totalPage&nrp=$nrp&warna=$warna'>Last&gt;&gt;</a>";
							}
						}
							//END OF PAGING ?>
