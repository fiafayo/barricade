		...
		<div id="content">
            <table border="0" width="100%" height="350px">
			  <tr>
				...
				<p>
				 <p>Selamat datang Dekan/Wakil Dekan, di website Academic Advisor Universitas Surabaya. </p>
			<p>Fasilitas yang dimiliki oleh Dekan/Wakil Dekan pada website ini antara lain:<br/>
