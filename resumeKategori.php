...
<?php  include_once('header.php'); ?>
		...
		<tr>
			<td valign="top">
			<br/><div style="font-size:20px" align="center">LAPORAN KATEGORI MASALAH</div><br/>
			<form action="resumeKategori.php" method="post">
				<table border="0" align="center" cellpadding="2" cellspacing="2" width="100%">
				  ...
				  <tr>
				  	<td colspan="2" align="center"><input type="button" onClick="javascript:poptastic('detailResumeKategori.php?fakultas='+document.getElementById('fakultas').value+'&jurusan='+document.getElementById('jurusan').value+'&semester='+document.getElementById('cboSemester').value);" value="Lihat Grafik" /><br/><br/></td>
				  </tr>
